...
def main(filename=None, auto_flag=False, scan_type='live', ui=None):
    ...
    scan1.fit_spindle2(axial_cutoff=-112, num_bins=100, circle_resid_tol=[1.0, 0.5, 0.25], min_fit_points=100, centers_resid_tol=[1.0, 0.5, 0.25], show=False, plot=False)
...
if __name__ == "__main__":
    main(filename=r'RealScans\BareSpindle10.csv')

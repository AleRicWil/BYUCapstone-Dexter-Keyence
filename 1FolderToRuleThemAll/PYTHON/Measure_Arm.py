...
def main(filename=None, auto_flag=False, scan_type='live', ui=None):
    ...
    scan1 = Torsion_Arm_LJS640(filename, view_angle_horizontal=45, scanType='live',
                               cutOff=[-500, 500, -184, 500, -500, 225] # z, x, y min & max
                               )
    # scan1.show_cloud()
    ...
    # Find spindle
    scan1.fit_spindle(axial_cutoff=-85, num_bins=100, circle_fit_tol=0.13, show=True, plot=False)
...
if __name__ == "__main__":
    main(filename=r'RealScans\SpindleSettings10.csv')

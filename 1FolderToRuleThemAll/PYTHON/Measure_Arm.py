...
def main(filename=None, auto_flag=False, scan_type='live', ui=None):
    ...
    scan1 = Torsion_Arm_LJS640(filename, view_angle_horizontal=45, scanType='live',
                               cutOff=[-500, 500, -500, 225, -500, 500], # z, x, y min & max
                               ui=None)
    # scan1.show_cloud()
    ...
    #scan1.fit_spindle2(axial_cutoff=-105, num_bins=100, circle_fit_tol=0.2, circle_resid_tol=[1.0], min_fit_points=300, centers_resid_tol=[2.0], show=True, plot=False)
...
if __name__ == "__main__":
    main(filename=r'RealScans\1A\1AA01.csv')

...
def perform_scan(ip0, ip1, ip2, ip3, return_type="mm"):
    ...
    ethernetConfig.abyIpAddress[0] = ip0    # IP address
    ethernetConfig.abyIpAddress[1] = ip1 
    ethernetConfig.abyIpAddress[2] = ip2 
    ethernetConfig.abyIpAddress[3] = ip3 

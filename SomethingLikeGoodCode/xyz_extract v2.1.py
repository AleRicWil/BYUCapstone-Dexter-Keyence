...
if __name__ == "__main__":
    ...
    # Plot_All(myPoints,plotNum=1, title='Filtered Data')
    ...
    myHubFace, myHubFaceAvg = Find_Grid_HubFace(myLedges, myLedgeAvgs, reverse=False)
    myPlane, myAngle = Calc_Plane(myHubFace, title='Filtered Best Plane. NO Noise')
